...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create competition' do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { current: @competition.current, name: @competition.name } }
    end
  ...
  test 'should update competition' do
    patch competition_url(@competition), params: { competition: { current: @competition.current, name: @competition.name } }
